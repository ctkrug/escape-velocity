...
- [ ] **1.1 Two-body gravity simulation engine**
...
- [ ] **1.2 Canvas rendering of planet, satellite, and live trajectory trace**
...
- [ ] **1.3 Drag-to-launch input handling (mouse + touch)**
...
- [ ] **1.4 Outcome resolution & feedback (crash / orbit / escape)**
...
- [ ] **2.1 HUD readouts (velocity, altitude, apoapsis/periapsis, orbital period)**
...
- [ ] **2.3 Responsive layout for 390px / 768px / 1440px**
...
- [ ] **2.4 Reduced-motion & keyboard accessibility pass**
...
- [ ] **3.2 Adjustable gravity strength**
...
- [ ] **3.4 Design polish — signature detail**
...
- [ ] **4.1 Landing page brand consistency**
